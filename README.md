...
### PSPortable
This is a portable PowerShell 7 package with multiple included modules and a Profile. It can be downloaded using a single command and used right away. The idea behind this is you can maintain the same PowerShell environment across many servers with change tracking.
